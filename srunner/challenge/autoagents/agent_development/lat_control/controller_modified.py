"""
This is a modified version of controller.
API is fixed, using carla.transform to navigate.
...
class PIDLateralController():
    ...
    def _pid_control(self, transform, vehicle_transform):
        ...
        w_vec = np.array([transform.location.x -
                          v_begin.x, transform.location.y -
                          v_begin.y, 0.0])
