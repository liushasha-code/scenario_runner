...
if __name__ == '__main__':
    ...
    PARSER.add_argument("-a", "--agent", type=str, help="Path to Agent's py file to evaluate",
                        # default="/home/lyq/PycharmProjects/scenario_runner/srunner/challenge/autoagents/NPCAgent.py")
                        default = "/home/lyq/PycharmProjects/scenario_runner/srunner/challenge/autoagents/HumanAgent.py")
    PARSER.add_argument("--config", type=str, help="Path to Agent's configuration file", default="")
    PARSER.add_argument('--debug', type=int, help='Run with debug output',
                        default=1)
    ...
    PARSER.add_argument('--routes',
                        ...
                        default="/home/lyq/PycharmProjects/scenario_runner/srunner/challenge/routes_debug.xml")
    PARSER.add_argument('--scenarios',
                        help='Name of the scenario annotation file to be mixed with the route.',
                        default="/home/lyq/PycharmProjects/scenario_runner/srunner/challenge/all_towns_traffic_scenarios1_3_4.json")
    ...
    # CARLA_ROOT = "/home/lyq/CARLA_simulator/CARLA_095"  # carla 095
    CARLA_ROOT = "/home/lyq/CARLA_simulator/CARLA_098"  # carla 098

    ROOT_SCENARIO_RUNNER = "/home/lyq/PycharmProjects/scenario_runner"  # using v095 scenario_runner
    # ROOT_SCENARIO_RUNNER = "/home/lyq/carla_ref/scenario_runner"  # using newest version of scenario_runner
